...
main(int argc, char *argv[])
{
  ...
  66:	c7 44 24 04 4a 08 00 	movl   $0x84a,0x4(%esp)
  6d:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 402:	8a 80 ac 0a 00 00    	mov    0xaac(%eax),%al
...
printf(int fd, char *fmt, ...)
{
 ...
 561:	75 25                	jne    588 <printf+0x11c>
          s = "(null)";
 563:	c7 45 f4 66 08 00 00 	movl   $0x866,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 62b:	a1 c8 0a 00 00       	mov    0xac8,%eax
...
free(void *ap)
{
 ...
 6f6:	a3 c8 0a 00 00       	mov    %eax,0xac8
}
 6fb:	c9                   	leave  
 6fc:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 749:	e8 ce fe ff ff       	call   61c <free>
  return freep;
 74e:	a1 c8 0a 00 00       	mov    0xac8,%eax
}
 753:	c9                   	leave  
 754:	c3                   	ret    
